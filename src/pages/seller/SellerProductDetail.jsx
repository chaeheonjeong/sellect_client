...
export default function SellerProductDetail() {
  ...
  const representativeImage =
    productDetail.images && productDetail.images.length > 0
      ? productDetail.images.find((img) => img.representative)?.image_url ||
          ...
          <div className='bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between border border-gray-100'>
            <div>
              ...
              <h2 className='text-xl font-extrabold text-gray-900 mb-4'>
                {productDetail.name || '상품명'}
              </h2>
              <div className='text-sm text-gray-600 mb-6 space-y-2'>
                <p>
                  <span className='font-medium text-gray-800'>상품 ID:</span>{' '}
                  {productDetail.product_id || 'N/A'}
                </p>
                <p>
                ...
                <p>
                  <span className='font-medium text-gray-800'>재고:</span>{' '}
                ...
                <p>
                  ...
                  $
                  {productDetail.total_sales
                    ? productDetail.total_sales.toLocaleString()
                    : '0'}
                </p>
              </div>
              <div className='mt-4'>
