...
function ProductRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.categoryId)
      newErrors.categoryId = '소분류 카테고리를 선택해주세요.';
    ...
    try {
      ...
      formDataToSend.append(
        'register_request',
        new Blob([JSON.stringify(registerRequest)], {
                      ...
                      >
                        ...
                        {formData.largeCategoryId &&
                          categories
                            .find(
                              (cat) =>
                                cat.id === Number(formData.largeCategoryId)
                            )
                            ?.children.map((child) => (
                      ...
                      >
                        ...
                        {formData.mediumCategoryId &&
                          categories
                            ...
                            ?.children.find(
                              (child) =>
                                child.id === Number(formData.mediumCategoryId)
                            )
