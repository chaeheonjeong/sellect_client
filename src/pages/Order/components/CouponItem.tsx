...
interface CouponInfoType {
  coupon: CouponOrderType;
  applyCoupon: (discountCost: number) => void;
}

function CouponInfo({ coupon, applyCoupon }: CouponInfoType) {
  return (
    <div
      ...
      onClick={() => applyCoupon(coupon.discount_cost)} // 클릭 시 쿠폰 적용
    >
      {/* 왼쪽: 쿠폰 아이콘과 할인 금액 */}
